...
limpiar_dir_tmp() {
	...
	then
		...
		borrar_directorio "${DIR_TMP}/Sorys_Astra"
		...
		borrar_fichero "${DIR_TMP}/Sorys_Astra.zip"
...
then
	URL=https://github.com/kmy78/Sorys_Astra/archive/master.zip
	URL_ACTUALIZACION=https://raw.githubusercontent.com/kmy78/Sorys_Astra/master/actualizacion
	CARPETA=Sorys_Astra
else
...
URL=https://raw.githubusercontent.com/kmy78/enigma2_pre_start/master/enigma2_pre_start.sh
